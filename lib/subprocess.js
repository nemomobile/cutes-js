...
var process = function(presets) {
    ...
    var get_error = function() {
        if (!errors_) {
            errors_ = {};
            errors_[Process.ProcessError.FailedToStart] = "FailedToStart";
            errors_[Process.ProcessError.Crashed] = "Crashed";
            errors_[Process.ProcessError.Timedout] = "Timedout";
            errors_[Process.ProcessError.WriteError] = "WriteError";
            errors_[Process.ProcessError.ReadError] = "ReadError";
            errors_[Process.ProcessError.UnknownError] = "UnknownError";
        };
        ...
        return (status === Process.ExitStatus.NormalExit
                && (e === Process.ProcessError.UnknownError
                    || (is_finished && e == Process.ProcessError.Timedout))
                ? undefined
                : errors_[e]);
    };
    ...
    that = {
        ...
        wait : function(timeout) {
            var is_running = function() {
                return p.state() === Process.ProcessState.NotRunning;
            };
