...
var dump = function(prefix, o) {
    var dump_object = function(indent, prefix, o) {
        var name = [prefix, String(typeof o)].join(':');
        var lines = [[indent, name, '{'].join('')];
        var prev_indent = indent;
        indent += '  ';
        eachProperty(o, function(n, v) {
            if (typeof v !== 'object') {
                lines.push([indent + n, v].join('='));
            } else {
